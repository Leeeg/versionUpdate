...
import com.lee.versioncheck.util.CheckVersionAsyncTask;
import com.lee.versioncheck.util.DownloadAsyncTask;
import com.lee.versioncheck.util.FileUtil;
import com.lee.versioncheck.util.GsonInner;
...
public class VersionCheckerImpl implements VersionCheckerPresenter {
    ...
    public void download(VersionResponse versionResponse) {
        DownloadAsyncTask.doExecute(downloadResult, versionResponse.getVersionCode(), versionResponse.getAppName(), versionResponse.getDownloadUrl(), versionResponse.getMd5());
    }
